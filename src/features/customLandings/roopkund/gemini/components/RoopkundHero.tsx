...
export const RoopkundHero: React.FC<RoopkundHeroProps> = ({ onExploreTrail, onOpenEnquiry, onOpenShare }) => {
  const { pkg, business } = useRoopkundIntegration();
  const [scrollY, setScrollY] = useState(0);
  const destination = String(pkg.destination || pkg.location || 'Roopkund • Details under review');
  const duration = String(pkg.duration || 'To be confirmed');
  ...
  return (
    <section id="hero" className="relative min-h-screen w-full flex flex-col justify-between overflow-hidden bg-[#0B131F] text-white">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-32 sm:pt-36 lg:pt-44 pb-12 flex-1 flex flex-col justify-center items-center text-center">
        ...
        <div className="flex flex-wrap items-center justify-center gap-3 text-[10px] sm:text-xs font-oswald tracking-[0.25em] text-[#E5C378] uppercase mb-6 sm:mb-8 animate-in fade-in slide-in-from-bottom-3 duration-700">
          ...
          <div className="hidden sm:inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-black/40 backdrop-blur-md border border-white/10 text-white/70">
            ...
            <span>COORDINATES TO BE CONFIRMED</span>
          </div>
        </div>
        ...
        <p className="mt-4 sm:mt-6 text-lg sm:text-2xl md:text-3xl font-garamond italic text-white/90 max-w-3xl tracking-wide font-normal">
          Explore the unseen with {business.companyName}.
        </p>
        ...
        <p className="mt-4 sm:mt-6 text-xs sm:text-sm md:text-base font-nunito text-white/80 max-w-2xl font-light leading-relaxed text-pretty">
          {pkg.shortDescription || 'The final route, duration and operating details are being reviewed by Pravaah Travels.'}
        </p>
        ...
        <div className="mt-8 sm:mt-10 grid grid-cols-2 sm:grid-cols-4 gap-3 sm:gap-4 w-full max-w-3xl">
          <div className="relative p-3.5 sm:p-4 rounded-xl bg-black/45 backdrop-blur-md border border-white/15 text-left group hover:border-[#E5C378]/50 transition-colors">
            ...
            <div className="text-base sm:text-lg font-oswald font-bold text-white mt-0.5 tracking-wider">TO BE CONFIRMED</div>
            <div className="text-[11px] font-nunito text-white/60">Final altitude under review</div>
          </div>
          ...
          <div className="relative p-3.5 sm:p-4 rounded-xl bg-black/45 backdrop-blur-md border border-white/15 text-left group hover:border-[#E5C378]/50 transition-colors">
            ...
            <div className="text-base sm:text-lg font-oswald font-bold text-white mt-0.5 tracking-wider">{duration.toUpperCase()}</div>
            <div className="text-[11px] font-nunito text-white/60">Final route under review</div>
          </div>
          ...
          <div className="relative p-3.5 sm:p-4 rounded-xl bg-black/45 backdrop-blur-md border border-white/15 text-left group hover:border-[#E5C378]/50 transition-colors">
            ...
            <div className="text-base sm:text-lg font-oswald font-bold text-white mt-0.5 tracking-wider">TO BE CONFIRMED</div>
            <div className="text-[11px] font-nunito text-white/60">Terrain details under review</div>
          </div>
          ...
          <div className="relative p-3.5 sm:p-4 rounded-xl bg-black/45 backdrop-blur-md border border-white/15 text-left group hover:border-[#E5C378]/50 transition-colors">
            ...
            <div className="text-base sm:text-lg font-oswald font-bold text-white mt-0.5 tracking-wider">EXPEDITION</div>
            <div className="text-[11px] font-nunito text-white/60">Subject to final confirmation</div>
          </div>
        </div>
