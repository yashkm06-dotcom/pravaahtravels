...
const MILESTONES: TrailMilestone[] = [
  { sectionId: 'hero', name: 'Expedition Base', altitude: '7,600 FT', percentage: 0 },
  { sectionId: 'mystery', name: 'The Mystery & Lore', altitude: 'Ancient Lake', percentage: 10 },
  { sectionId: 'why-roopkund', name: 'Trail Highlights', altitude: 'Garhwal Range', percentage: 20 },
  { sectionId: 'expedition-route', name: 'Expedition Pipeline', altitude: 'Bioclimatic Zones', percentage: 32 },
  { sectionId: 'places', name: 'Sanctuaries & Camps', altitude: 'Ali to Didna', percentage: 44 },
  { sectionId: 'itinerary', name: '8-Day Day-by-Day', altitude: 'Ascent Vectors', percentage: 55 },
  { sectionId: 'elevation', name: 'Elevation Profile', altitude: '15,750 FT Summit', percentage: 66 },
  { sectionId: 'experience', name: 'Sensory Chapters', altitude: 'Bugyal & Snow', percentage: 76 },
  { sectionId: 'packing', name: 'Expedition Gear', altitude: 'Sub-Zero Tier', percentage: 84 },
  { sectionId: 'faq', name: 'Medical & FAQs', altitude: 'AMS & Fitness', percentage: 90 },
  { sectionId: 'why-pravaah', name: 'Mountain Safety', altitude: '1:6 Ratio Ground', percentage: 95 },
  { sectionId: 'booking', name: 'Admissions & Booking', altitude: 'Reserve Slot', percentage: 100 },
];
...
export const ScrollProgressIndicator: React.FC = () => {
  ...
  return (
    <div
      className="fixed top-0 left-0 right-0 z-[100] group"
    ...
    >
      ...
      <div
        className={`fixed top-3 right-4 sm:right-8 transition-all duration-300 pointer-events-auto ${
          showTelemetryPill
      ...
      {isHovered && (
        <div className="absolute top-[3px] left-0 right-0 bg-[#0D1812]/95 border-b border-[#253D30] backdrop-blur-md px-4 py-2 hidden md:flex items-center justify-between animate-in fade-in slide-in-from-top-1 duration-200 shadow-2xl">
          <div className="flex items-center gap-2 text-[10px] font-oswald tracking-[0.2em] text-[#E5C378] uppercase">
            ...
            <span>TRAIL DESCENT & ELEVATION TIMELINE</span>
          </div>
