...
import { Mountain, AlertTriangle, ShieldCheck, TrendingUp, Info } from 'lucide-react';
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-12">
          <div>
            <span className="text-xs font-oswald tracking-[0.25em] text-[#134E35] uppercase font-bold">
              ALTITUDE PROGRESSION & ACCLIMATIZATION CURVE
            </span>
          ...
          <div className="text-xs sm:text-sm font-garamond italic text-[#4A5568] max-w-md text-pretty">
            Interactive elevation graph demonstrating Pravaah’s gradual height adaptation protocol from 1,120 ft up to the Roopkund glacial summit at 15,750 ft.
          </div>
        </div>
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                <div className="text-[11px] font-oswald uppercase text-[#8F4F38] tracking-widest font-bold">
                  CHECKPOINT DETAILS (DAY {activePoint.day})
                </div>
            ...
            <div className="flex items-center gap-6">
              <div>
                ...
                <div className="text-xl sm:text-2xl font-oswald font-bold text-[#134E35] tracking-wide">
                  {activePoint.altitudeFeet.toLocaleString()} FT
                </div>
              </div>
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                <div className="text-xs font-oswald uppercase tracking-wider text-[#1D2530] font-bold">
                  HIGH-ALTITUDE EXPEDITION STANDARDS
                </div>
                <div className="text-xs text-[#4A5568] font-nunito mt-0.5">
                  Above 10,000 ft, atmospheric pressure and oxygen partial pressure drop significantly. Pravaah enforces strict hydration protocols and pulse-oximetry checks.
                </div>
              </div>
            </div>
