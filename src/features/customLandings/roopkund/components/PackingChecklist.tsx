          ...
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 mb-4">
            <div>
              <div className="text-[10px] font-oswald uppercase text-[#134E35] font-bold tracking-widest">
                EXPEDITION LOAD MATRIX // READINESS STATUS
              </div>
            ...
            <div className="text-xs font-nunito text-[#4A5568] max-w-sm text-pretty">
              {progressPercent === 100
                ? '🎉 Excellent! Your gear kit is 100% complete for the high altitude.'
                : 'Click items as you pack them into your expedition rucksack.'}
            </div>
          </div>
