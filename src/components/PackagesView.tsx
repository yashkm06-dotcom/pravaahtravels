      ...
      <div className="mx-auto max-w-[1320px] space-y-10 px-4 py-12 sm:px-6 lg:px-8">
        ...
        <div className="-mt-24 rounded-[14px] border border-stone-200 bg-white p-4 shadow-[0_24px_70px_rgba(18,38,32,0.18)] sm:p-6" id="filter-panel">
          ...
          <div className="grid grid-cols-1 gap-4 lg:grid-cols-4">
            ...
            <div className="relative col-span-1 lg:col-span-2">
              ...
              <input
                ...
                className="h-full min-h-14 w-full rounded-[12px] border border-stone-200 bg-[#fffaf1] py-4 pl-12 pr-4 text-sm font-semibold text-stone-900 transition-all focus:border-[#4DA528] focus:bg-white focus:outline-none"
              />
            </div>
          ...
          <div className="mt-5 flex flex-col items-start justify-between gap-4 sm:flex-row sm:items-center">
            {/* Price Range Slider */}
            <div className="flex w-full flex-col gap-2 rounded-[12px] bg-[#fffaf1] p-4 ring-1 ring-stone-200 sm:w-auto sm:min-w-[420px]">
