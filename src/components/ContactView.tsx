...
export default function ContactView({ onEnquirySuccess }: ContactViewProps) {
  ...
  return (
    <div id="contact-view" className="animate-fade-in bg-[#f8f7f4] py-16">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12">
        
        {/* Page Header */}
        <div className="text-center max-w-3xl mx-auto space-y-3">
          <span className="text-xs font-bold text-[#008080] tracking-[0.2em] uppercase">Plan with Experts</span>
          ...
          <p className="text-stone-500 text-xs sm:text-sm font-light max-w-md mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
          ...
          {/* Left Form: Column 7 */}
          <div className="lg:col-span-7 bg-white border border-stone-200 p-6 sm:p-8 rounded shadow-xs" id="contact-form-card">
            {submitSuccess ? (
              <div className="text-center py-12 space-y-4 animate-fade-in">
                <div className="w-12 h-12 bg-[#008080] text-white rounded-full flex items-center justify-center mx-auto shadow-sm">
                  <Check className="w-6 h-6" />
                </div>
                <h3 className="text-2xl font-serif italic text-[#333333]">Enquiry Received!</h3>
                ...
                <button
                  ...
                  className="px-6 py-2.5 bg-[#008080] hover:bg-[#006666] text-white text-[10px] font-bold uppercase tracking-wider rounded transition"
                >
              ...
              <form onSubmit={handleFormSubmit} className="space-y-6">
                <h3 className="text-lg font-serif italic text-[#333333] border-b border-stone-100 pb-3 flex items-center gap-2">
                  <Compass className="w-5 h-5 text-[#008080] animate-spin-slow" />
          ...
          <div className="lg:col-span-5 space-y-6">
            ...
            {/* Quick Contacts Card */}
            <div className="bg-stone-900 text-white rounded p-6 sm:p-8 space-y-6 shadow-md" id="contact-details-card">
              <h3 className="text-xl font-serif italic border-b border-stone-800 pb-4 text-[#F4C430]">
                Pravaah Headquarters
              </h3>
              
              <ul className="space-y-6 text-sm">
                <li className="flex items-start gap-4">
                  <MapPin className="w-6 h-6 text-[#008080] shrink-0 mt-1" />
                  <div className="space-y-1">
                    <strong className="block text-white font-serif italic text-sm">Office Address</strong>
                ...
                <li className="flex items-start gap-4">
                  <Phone className="w-6 h-6 text-[#008080] shrink-0 mt-1" />
                  <div className="space-y-1">
                    <strong className="block text-white font-serif italic text-sm">Direct Hotlines</strong>
                ...
                <li className="flex items-start gap-4">
                  <Mail className="w-6 h-6 text-[#008080] shrink-0 mt-1" />
                  <div className="space-y-1">
                    <strong className="block text-white font-serif italic text-sm">Email Addresses</strong>
            ...
            <div className="bg-white border border-stone-200 rounded p-6 sm:p-8 space-y-4 shadow-xs" id="office-hours-card">
              <h4 className="text-base font-serif italic text-[#333333] flex items-center gap-2">
