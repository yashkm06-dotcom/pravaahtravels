...
import { signInWithEmailAndPassword, createUserWithEmailAndPassword, signInWithPopup, GoogleAuthProvider, GithubAuthProvider, updateProfile, sendPasswordResetEmail, type User as FirebaseUser } from 'firebase/auth';
...
export default function LoginModal({ onLoginSuccess }: LoginModalProps) {
  ...
  const ensureUserProfile = async (
    ...
    const updateData: Record<string, any> = {
      ...
      email: user.email || '',
      role: checkIsAdmin(user.email || '') ? 'admin' : 'traveler',
      lastLogin: serverTimestamp(),
      updatedAt: serverTimestamp(),
      ...(existingUserDoc.exists() ? {} : { createdAt: serverTimestamp() }),
    };
